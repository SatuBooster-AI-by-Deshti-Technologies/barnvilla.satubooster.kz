    ...
    <div className="min-h-screen bg-background relative">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6 text-foreground">
              Почему <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Barnvilla</span>
            </h2>
          </div>
      ...
      <footer className="bg-card/50 backdrop-blur-sm py-12 px-4 border-t border-border/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h3 className="text-2xl font-bold mb-2 text-foreground">Barnvilla</h3>
          <p className="text-muted-foreground mb-6">Глэмпинг в горах Шымкента</p>
          <div className="flex justify-center gap-6 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              <Phone className="w-4 h-4" />
              <span>+7 (702) 303-04-40</span>
            </div>
            <div className="flex items-center gap-2">
